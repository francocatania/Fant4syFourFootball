...
app
	...
	.put('/week', (req, res) => db.updateCurrentWeek(req.body.season, req.body.week, res))
	.put('/playerdata/:season/:week', (req, res) => fdsApi.updateAllPlayerStatsFromApi(req.body.season, req.body.week, res))
